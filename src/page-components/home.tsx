        ...
        return (
            <div>
                <div className="row fadeInDown">
                        ...
                        <div className="fadeIn first">
                                <li className="list-group-item m-3">
                                    <img src={pythonlogo} alt="Project Icon" className="projectlogo" />
                        ...
                        <div className="fadeIn first">
                                <li className="list-group-item m-3">
                                    <img src={javalogo} alt="Project Icon" className="projectlogo" />
                        ...
                        <div className="fadeIn second">
                                <li className="list-group-item m-3">
                                    <img src={pythonlogo} alt="Project Icon" className="projectlogo" />
                                    <a className="pr-3" href="./editor">Fourth Project</a>
                                </li>
                ...
                <div className="fadeIn third position-absolute new">
                    <a href="/NewProject" className="btn btn-primary btn-lg active" role="button" aria-pressed="true">New Project</a>              
                </div>

                <div className="fadeIn third position-absolute join">
                    <a href="/JoinProject" className="btn btn-primary btn-lg active" role="button" aria-pressed="true">Join Project</a>
                </div>
